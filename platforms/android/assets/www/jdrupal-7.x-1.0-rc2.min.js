...
function drupal_init() {try {Drupal || (Drupal = {}), Drupal.csrf_token = !1, Drupal.sessid = null, Drupal.user = drupal_user_defaults(), Drupal.settings = {app_directory: 'app', base_path: '/', cache: {entity: {enabled: !1, expiration: 3600},views: {enabled: !1, expiration: 3600}},debug: !1, endpoint: '', file_public_path: 'sites/default/files', language_default: 'und', site_path: ''},Drupal.includes = {},Drupal.includes.module = {},Drupal.modules = {core: {},contrib: {},custom: {}}}catch (a) {console.log('drupal_init - '+ a)}}
function dpm(a) {try {a && ('object'=== typeof a ? console.log(JSON.stringify(a)) : console.log(a))}catch (b) {console.log('dpm - '+ b)}}function drupal_user_defaults() {return{uid: '0', roles: {1: 'anonymous user'},permissions: []}}function empty(a) {return'undefined'=== typeof a || null === a || ''== a}function function_exists(a) {try {return'function'== eval('typeof '+ a)}catch (b) {alert('function_exists - '+ b)}}
function http_status_code_title(a) {try {var b = '';switch (a) {case 200: b = 'OK';break;case 401: b = 'Unauthorized';break;case 404: b = 'Not Found';break;case 406: b = 'Not Acceptable';break;case 500: b = 'Internal Server Error'}return b}catch (c) {console.log('http_status_code_title - '+ c)}}function in_array(a, b) {try {return-1 < b.indexOf(a)}catch (c) {console.log('in_array - '+ c)}}function is_int(a) {'string'=== typeof a && (a = parseInt(a));return'number'=== typeof a && 0 == a % 1}
function language_default() {try {return Drupal.settings.language_default && ''!= Drupal.settings.language_default ? Drupal.settings.language_default : 'und'}catch (a) {console.log('language_default - '+ a)}}function time() {return Math.floor(new Date / 1E3)}function ucfirst(a) {a += '';return a.charAt(0).toUpperCase() + a.substr(1)}
function module_implements(a) {try {var b = [];if (a)for (var c = module_types(), d = 0; d < c.length; d++) {var e = c[d], f;for (f in Drupal.modules[e])Drupal.modules[e].hasOwnProperty(f) && function_exists(f + '_'+ a) && b.push(f)}return 0 == b.length ? !1 : b}catch (g) {console.log('module_implements - '+ g)}}
...
function comment_save(a, b) {try {entity_save('comment', null, a, b)}catch (c) {console.log('comment_save - '+ c)}}function entity_delete(a, b, c) {try {var d = a + '_delete';if (function_exists(d))(0, window[d])(b, c);else console.log('WARNING: entity_delete - unsupported type: '+ a)}catch (e) {console.log('entity_delete - '+ e)}}function entity_local_storage_key(a, b) {return a + '_'+ b}
function entity_load(a, b, c) {try {if (is_int(b)) {var d = !1;if (Drupal.settings.cache.entity && Drupal.settings.cache.entity.enabled && (d = _entity_local_storage_load(a, b, c))) {c.success && c.success(d);return}if (in_array(a, entity_types())) {var e = entity_primary_key(a), f = {success: function(f) {try {d = f;if (Drupal.settings.cache.entity && Drupal.settings.cache.entity.enabled) {if ('undefined'!== Drupal.settings.cache.entity.expiration) {var e = time() + Drupal.settings.cache.entity.expiration;0 == Drupal.settings.cache.entity.expiration &&
(e = 0);d.expiration = e}_entity_local_storage_save(a, b, d)}c.success && c.success(d)}catch (g) {console.log('entity_load - success - '+ g)}},error: function(a, b, d) {try {c.error && c.error(a, b, d)}catch (f) {console.log('entity_load - error - '+ f)}}},g = a + '_retrieve';function_exists(g) ? (f[e] = b, (0, window[g])(b, f)) : console.log('WARNING: '+ g + '() does not exist!')}else e = 'WARNING: entity_load - unsupported type: '+ a, console.log(e), c.error && c.error(null, null, e)}else alert('entity_load('+ a + ') - only single ids supported!')}catch (h) {console.log('entity_load - '+
h)}}
function _entity_local_storage_load(a, b, c) {try {var d = !1;c && c.reset && _entity_local_storage_delete(a, b);var e = entity_local_storage_key(a, b);if (d = window.localStorage.getItem(e))d = JSON.parse(d), 'undefined'!== typeof d.expiration && 0 != d.expiration && time() > d.expiration ? (_entity_local_storage_delete(a, b), d = !1) : drupalgap && drupalgap.page.options && drupalgap.page.options.reloadingPage && ('undefined'=== typeof drupalgap.page.options.reset || !1 != drupalgap.page.options.reset) && (_entity_local_storage_delete(a, b), d = !1);
...
Drupal.services.call = function(a) {try {if (a.debug = !1, services_ready()) {module_invoke_all('services_preprocess', a);var b = new XMLHttpRequest, c = Drupal.settings.site_path + Drupal.settings.base_path + '?q=';'undefined'=== typeof a.endpoint ? c += Drupal.settings.endpoint + '/': ''!= a.endpoint && (c += a.endpoint + '/');var c = c + a.path, d = a.method.toUpperCase();Drupal.settings.debug && console.log(d + ': '+ c);b.onload = function(f) {try {if (4 == b.readyState) {var e = b.status + ' - '+ http_status_code_title(b.status);if (200 == b.status) {Drupal.settings.debug &&
console.log('200 - OK');f = null;var h = b.getResponseHeader('Content-Type');-1 == h.indexOf('application/json') ? (console.log('Drupal.services.call - ERROR - response header was '+ h + ' instead of application/json'), console.log(b.responseText)) : f = JSON.parse(b.responseText);module_invoke_all('services_request_pre_postprocess_alter', a, f);a.success(f);module_invoke_all('services_request_postprocess_alter', a, f);module_invoke_all('services_postprocess', a, f)}else {Drupal.settings.debug && (console.log(d + ': '+ c + ' - '+
e), console.log(b.responseText), console.log(b.getAllResponseHeaders()));b.responseText ? console.log(b.responseText) : dpm(b);if ('undefined'!== typeof a.error) {var k = b.responseText || '';k && ''!= k || (k = e);a.error(b, b.status, k)}module_invoke_all('services_postprocess', a, b)}}else console.log('Drupal.services.call - request.readyState = '+ b.readyState)}catch (l) {Drupal.settings.debug && (console.log(d + ' (ERROR): '+ c + ' - '+ e), console.log(b.responseText), console.log(b.getAllResponseHeaders())), console.log('Drupal.services.call - onload - '+
l)}};services_get_csrf_token({debug: a.debug, success: function(f) {try {var e = !0;'undefined'!== typeof a.async && !1 === a.async && (e = !1);b.open(d, c, e);'POST'== d ? (e = 'application/json', 'user'== a.service && 'login'== a.resource && (e = 'application/x-www-form-urlencoded'), b.setRequestHeader('Content-type', e)) : 'PUT'== d && b.setRequestHeader('Content-type', 'application/json');f && b.setRequestHeader('X-CSRF-Token', f);'undefined'!== typeof a.data ? (Drupal.settings.debug && (f = !0, 'user'== a.service && in_array(a.resource, ['login',
'create', 'update']) && (f = !1), f && ('object'=== typeof a.data ? console.log(JSON.stringify(a.data)) : console.log(a.data))), b.send(a.data)) : b.send(null)}catch (h) {console.log('Drupal.services.call - services_get_csrf_token - success - '+ h)}},error: function(b, c, d) {try {console.log('Drupal.services.call - services_get_csrf_token - '+ d), a.error && a.error(b, c, d)}catch (e) {console.log('Drupal.services.call - services_get_csrf_token - error - '+ e)}}})}else a.error(null, null, 'Set the site_path and endpoint on Drupal.settings!')}catch (e) {console.log('Drupal.services.call - error - '+
e)}};
function services_get_csrf_token(a) {try {var b;a.reset && (Drupal.sessid = null);Drupal.sessid && (b = Drupal.sessid);if (b)a.success && a.success(b);else {var c = new XMLHttpRequest, d = Drupal.settings.site_path + Drupal.settings.base_path + '?q=services/session/token';c.onload = function(e) {try {if (4 == c.readyState) {var g = c.status + ' - '+ http_status_code_title(c.status);200 != c.status ? (console.log(d + ' - '+ g), console.log(c.responseText)) : (b = c.responseText, Drupal.sessid = b, a.success && a.success(b))}else console.log('services_get_csrf_token - readyState - '+ c.readyState)}catch (h) {console.log('services_get_csrf_token - token_request. onload - '+
h)}};c.open('GET', d, !0);c.send(null)}}catch (e) {console.log('services_get_csrf_token - '+ e)}}function services_ready() {try {var a = !0;''== Drupal.settings.site_path && (a = !1, console.log("jDrupal's Drupal.settings.site_path is not set!"));''== Drupal.settings.endpoint && (a = !1, console.log("jDrupal's Drupal.settings.endpoint is not set!"));return a}catch (b) {console.log('services_ready - '+ b)}}
function services_resource_defaults(a, b, c) {try {a.service || (a.service = b), a.resource || (a.resource = c)}catch (d) {console.log('services_resource_defaults - '+ d)}}function comment_create(a, b) {try {services_resource_defaults(b, 'comment', 'create'), entity_create('comment', null, a, b)}catch (c) {console.log('comment_create - '+ c)}}function comment_retrieve(a, b) {try {services_resource_defaults(b, 'comment', 'retrieve'), entity_retrieve('comment', a, b)}catch (c) {console.log('comment_retrieve - '+ c)}}
function comment_update(a, b) {try {services_resource_defaults(b, 'comment', 'update'), entity_update('comment', null, a, b)}catch (c) {console.log('comment_update - '+ c)}}function comment_delete(a, b) {try {services_resource_defaults(b, 'comment', 'delete'), entity_delete('comment', a, b)}catch (c) {console.log('comment_delete - '+ c)}}function comment_index(a, b) {try {services_resource_defaults(b, 'comment', 'index'), entity_index('comment', a, b)}catch (c) {console.log('comment_index - '+ c)}}
...
function user_create(a, b) {try {services_resource_defaults(b, 'user', 'create'), entity_create('user', null, a, b)}catch (c) {console.log('user_create - '+ c)}}function user_retrieve(a, b) {try {services_resource_defaults(b, 'user', 'create'), entity_retrieve('user', a, b)}catch (c) {console.log('user_retrieve - '+ c)}}function user_update(a, b) {try {var c = 'create';a.uid && (c = 'update');services_resource_defaults(b, 'user', c);entity_update('user', null, a, b)}catch (d) {console.log('user_update - '+ d)}}
